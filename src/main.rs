...
fn handle_agent_commands(
    ...
    match action {
        ...
        AgentAction::Approve => {
            if uhoh::agent::approve_pending_actions(uhoh_dir, true)? > 0 {
        ...
        AgentAction::Deny => {
            if uhoh::agent::deny_pending_actions(uhoh_dir)? > 0 {
        ...
        AgentAction::Resume => {
            if uhoh::agent::approve_pending_actions(uhoh_dir, false)? > 0 {
